...
| Inference spot-check | `uv run python model/pred.py --pt pt` | `data/pred.jsonl` — top styles/emoji + predicted colors (`bg`/`fg`) for the first 200 eval rows. Eyeball concrete failures. |
