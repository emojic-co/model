...
# EMOJI
EMOJI_EMBED_SIZE = 64
EMOJI_EFFECTIVE_TEXT_EMBED_SIZE = EMOJI_COUNT // 2
...
# STYLE
STYLE_EMBED_SIZE = 16
STYLE_EFFECTIVE_TEXT_EMBED_SIZE = max(100, STYLE_COUNT)
...
# GAN
Z_WEIGHT = 0.1
GEN_CHANNELS = [128, 64, 32]
CRITIC_COLOR_CHANNELS = [64]
CRITIC_TEXT_CHANNELS = [64]
CRITIC_EFFECTIVE_TEXT_EMBED_SIZE = 200
DROPOUT_CRITIC = 1 - CRITIC_EFFECTIVE_TEXT_EMBED_SIZE / TEXT_EMBED_SIZE
GAN_GEN_LR = 0.01
GAN_CRITIC_LR = 0.02
GAN_GEN_MARGIN = 1.0
